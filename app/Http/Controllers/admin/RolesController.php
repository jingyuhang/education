...
class RolesController extends Controller
{
    public function index()
    {
        ...
        return view('adminRight.roles.index', ['roles' => $roles]);
    }
    ...
    public function create()
    {
        ...
        return view('adminRight.roles.create', ['permissions' => $permissions]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        if (!$role_id) {
            ...
            if (!$role) {
                ...
                //该角色具有的权限组id
                $permission_ids = RolesPermission::where('roles_id', '=', $role_id)->pluck('permission_id')->toArray();
            }
        }
        ...
        return view('adminRight.roles.edit', ['permissions' => $permissions, 'error' => $error, 'permission_ids' => $permission_ids, 'role' => $role]);
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            //删除旧的关联关系
            RolesPermission::where('roles_id', '=', $params['id'])->delete();
    ...
    public function delete(Request $request)
    {
        ...
        try {
            ...
            RolesPermission::where('id', $id)->delete();
            DB::commit();
