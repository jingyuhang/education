...
class MenuController extends Controller
{
    public function index()
    {
        ...
        return view('adminRight.menu.index', ['menu' => json_encode($menu_arr)]);
    }
    ...
    public function create()
    {
        ...
        return view('adminRight.menu.create', ['top_menu' => $top_menu, 'routes' => $routes, 'roles' => $roles]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('adminRight.menu.edit', ['roles' => $roles, 'error' => $error, 'role_ids' => $role_ids, 'menu' => $menu, 'top_menu' => $top_menu, 'routes' => $routes]);
    }
