...
class UserController extends Controller
{
    public function index()
    {
        ...
        return view('adminRight.user.index', ['users' => $users]);
    }
    ...
    public function create()
    {
        ...
        return view('adminRight.user.create', ['roles' => $roles,'user_id'=>$user_id]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('adminRight.user.edit', ['roles' => $roles, 'error' => $error, 'role_ids' => $role_ids, 'user' => $user]);
    }
