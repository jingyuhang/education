...
class PermissionController extends Controller
{
    public function index()
    {
        ...
        return view('adminRight.permission.index', ['permissions' => $permissions]);
    }
    ...
    public function create()
    {
        ...
        return view('adminRight.permission.create', ['routes' => $routes]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('adminRight.permission.edit', ['permission' => $permission, 'error' => $error, 'routes' => $routes]);
    }
